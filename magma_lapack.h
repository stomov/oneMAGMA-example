...
magma_int_t lapackf77_ieeeck( const magma_int_t *ispec, const float *zero, const float *one ) noexcept;

long   lapackf77_lsame(  const char *ca, const char *cb );

float  lapackf77_slamch( const char *cmach ) noexcept;
double lapackf77_dlamch( const char *cmach ) noexcept;

// "small" (lowercase) defined as char on Windows (reported by MathWorks)
void   lapackf77_slabad( float  *Small, float  *large ) noexcept;
void   lapackf77_dlabad( double *Small, double *large ) noexcept;
...
double lapackf77_dlapy2( const double *x, const double *y ) noexcept;
float  lapackf77_slapy2( const float  *x, const float  *y ) noexcept;
