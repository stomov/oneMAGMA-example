/*
    -- MAGMA (version 2.0) --
       ...
       @generated from include/magma_zlapack.h, normal z -> s, Thu Jul 14 01:12:55 2022
*/
...
void   lapackf77_sgglse( const magma_int_t *m, const magma_int_t *n, const magma_int_t *p,
                         float *A, const magma_int_t *lda,
                         float *B, const magma_int_t *ldb,
                         float *c, float *d, 
                         float *x,
...
void   lapackf77_sggrqf( const magma_int_t *m, const magma_int_t *p, const magma_int_t *n,
                         float *A, const magma_int_t *lda,
                         float *tauA, float *B,
                         const magma_int_t *ldb, float *tauB,
                         float *work, const magma_int_t *lwork, 
                         magma_int_t *info) noexcept;
...
void   lapackf77_slabrd( const magma_int_t *m, const magma_int_t *n, const magma_int_t *nb,
                         ...
                         float *Y, const magma_int_t *ldy ) noexcept;

#ifdef MAGMA_COMPLEX
void   lapackf77_slacgv( const magma_int_t *n,
                         float *x, const magma_int_t *incx ) noexcept;
#endif
...
void   lapackf77_slacp2( const char *uplo,
                         const magma_int_t *m, const magma_int_t *n,
                         const float *A, const magma_int_t *lda,
                         float *B, const magma_int_t *ldb ) noexcept;
#endif
...
float lapackf77_slanst( const char *norm, const magma_int_t *n,
                         const float *d, const float *e ) noexcept;
...
void   lapackf77_slarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         ...
                         float *C, const magma_int_t *ldc,
                         float *work, const magma_int_t *ldwork ) noexcept;
...
void   lapackf77_slarft( const char *direct, const char *storev,
                         ...
                         const float *V, const magma_int_t *ldv,
                         const float *tau,
                         float *T, const magma_int_t *ldt ) noexcept;
...
void   lapackf77_slaset( const char *uplo,
                         ...
                         const float *alpha,
                         const float *beta,
                         float *A, const magma_int_t *lda ) noexcept;
...
void   lapackf77_ssymv(  const char *uplo,
                         ...
                         const float *x, const magma_int_t *incx,
                         const float *beta,
                               float *y, const magma_int_t *incy ) noexcept;
...
float lapackf77_sqpt01( const magma_int_t *m, const magma_int_t *n, const magma_int_t *k,
                         ...
                         float *work, const magma_int_t *lwork ) noexcept;
