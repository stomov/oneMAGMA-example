/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas/zgemm_fermi.cu, normal z -> s, Fri Jul  8 13:17:51 2022
...
extern "C" void magmablas_sgemm2(magma_trans_t transA, magma_trans_t transB,
   ...
   cgh.parallel_for(
       ...
       [=](sycl::nd_item<3> item_ct1) {
        sgemm_kernel_fermi_nn(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta, (int)offsetA,
            (int)offsetB, item_ct1, sA_acc_ct1, sB_acc_ct1);
       });
  });
    }
